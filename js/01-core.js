...
'view-pignorado':`Simula pedir prestado contra tu cartera <b>sin vender nada</b> —crédito lombardo o préstamo pignorado— para aumentar tus ingresos sin descapitalizarte. El <b>LTV</b> (loan-to-value: deuda ÷ valor de la cartera) es la garantía real del préstamo: cuanto más bajo, más margen tienes si la bolsa cae, porque el banco puede exigir garantías extra o vender parte de la cartera si el LTV sube demasiado (los bancos suelen actuar entre el 50% y el 70%, según el caso). Dos modos: <b>«Gasto a partir de una edad»</b> —no pides nada hasta la edad que fijes, y desde entonces retiras una cantidad fija cada año, con la deuda acumulándose sola o pagando tú el interés de tu bolsillo— y <b>Carry</b> —pides una vez y vives del margen entre el dividendo de lo comprado con el préstamo y su interés—. Es una simulación con supuestos constantes, no una oferta real: antes de usarlo, habla con tu banco sobre el LTV y el tipo que te ofrecería sobre tus acciones.`,
};
