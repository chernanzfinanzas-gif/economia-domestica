...
function renderPlanLote(){
  ...
  const pendRow='<tr class="pendrow"><td></td><td title="Presupuesto bruto − compras del plan (Kanban) ejecutadas ese año">Disponible</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>'+yrs.map(y=>{ const disp=dispShown(y); return `<td class="num yc ${disp<-0.5?'neg':(disp>0.5?'pos':'')}">${fmt(disp)}</td>`; }).join('')+'<td></td></tr>';
