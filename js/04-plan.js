...
function renderProxMos(){
  ...
  var _razonRow=function(r){ var d=r.dec?('<b style="color:'+_decCol(r.dec)+'">'+r.dec+'</b> · '):''; return '<tr class="mos-razon"><td></td><td colspan="8" style="text-align:left;white-space:normal;word-break:normal;font-size:11px;color:#475569;padding:2px 10px 10px 10px;line-height:1.5">💬 '+d+_razon(r)+'</td></tr>'; };
