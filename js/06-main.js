...
function activarVista(view){
  ...
  if(view==='simulador') window._simSeek=true;
...
document.addEventListener('click',e=>{ if(e.target&&e.target.closest&&e.target.closest('#loteAdd')){ if(typeof addLoteEmpresa==='function')addLoteEmpresa(); } });
