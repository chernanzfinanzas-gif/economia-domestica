...
function activarVista(view){
  ...
  if(view==='prevision'){ window._evoTablaOpen=false; window._evoChowOpen=false; setTimeout(()=>autoFitTable('prevTabla',7,11),120); }
