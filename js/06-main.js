...
$('#panelDash').addEventListener('click',e=>{ const h=e.target.closest('[data-goto]'); if(!h)return; if(h.dataset.sig&&typeof showProtocolo==='function'){ showProtocolo(h.dataset.sig,h.dataset.goto,h.dataset.ticker||''); return; } if(typeof activarVista==='function') activarVista(h.dataset.goto); });
if($('#view-asignacion')){
